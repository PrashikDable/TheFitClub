...
public class mesure_history {
	...
	private int user_id;
	public mesure_history() {
		super();
	}
	public mesure_history(int mesurement_id, String chest, String arm, String waist, String thigh, String calf,
	...
	public String toString() {
		return "mesure_history [mesurement_id=" + mesurement_id + ", chest=" + chest + ", arm=" + arm + ", waist="
