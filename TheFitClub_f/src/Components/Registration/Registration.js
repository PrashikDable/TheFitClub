...
const Registration = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!fitness_goal) newErrors.fitness_goal = 'fitness_goal is required.';
    if (!diet_preference) newErrors.diet_preference = 'diet_preference is required.';
    ...
    <div className="container-reg">
      ...
      <form onSubmit={handleSubmit}>
          ...
          DOB: <input className='reg-input'
            ...
            phone_no: <input className='reg-input'
              type="text"
           ...
           fitness_goal:  <input className='reg-input'
              type="text"
           ...
           diet_preference: <input className='reg-input'
              type="text"
            ...
            />
             paasword: <input className='reg-input'
              type="password"
